#!/usr/bin/env python3
# backtest_top10_block_report_v1.py
# Build weekly block metrics for top-N subsets from feature_subset_search_v1.csv.
...
def run_one_subset(df_all, feature_cols, block_days=7, test_year=2025):
    ...
    while block_start <= last_test_date:
        ...
        # LR requires at least 2 classes in train
